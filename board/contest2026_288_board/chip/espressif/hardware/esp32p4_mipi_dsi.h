 ...
 * ESP-IDF register map (hw_ver3): DR_REG_DSI_HOST_BASE =
 * DR_REG_HPPERIPH0_BASE(0x50000000) + 0xA0000.
 */

#define ESP32P4_MIPI_DSI_HOST_BASE    0x500A0000

/* MIPI DSI Bridge Register Base Address
 * ESP-IDF register map (hw_ver3): DR_REG_DSI_BRG_BASE = + 0xA0800.
 */

#define ESP32P4_MIPI_DSI_BRG_BASE     0x500A0800
...
#define DSI_HOST_PHY_TST_CTRL0        0x0b4
#define DSI_HOST_PHY_TST_CTRL1        0x0b8
/* NOTE: offsets below (0xbc..) follow the ESP-IDF register map
 * (components/soc/esp32p4/register/mipi_dsi_host_reg.h), which differs
 * from the original vendor_esp32p4 header for INT_* blocks.
 */
#define DSI_HOST_INT_ST0              0x0bc
#define DSI_HOST_INT_ST1              0x0c0
#define DSI_HOST_INT_MASK0            0x0c4
#define DSI_HOST_INT_MASK1            0x0c8
#define DSI_HOST_INT_FORCE0           0x0d8
#define DSI_HOST_INT_FORCE1           0x0dc
...
/* ESP-IDF: PHY_TMR_RD_CFG sits at 0xf4 (not 0xb4 as in the original
 * vendor_esp32p4 header, which also allocated 0xb4/0xb8 to INT state). */

#define DSI_HOST_PHY_TMR_RD_CFG       0x0f4
